...
def tridiaglu(np.ndarray[double,ndim=2] Amat):
    cdef np.ndarray[double,ndim=2] Lmat
    cdef np.ndarray[double,ndim=2] Umat
    cdef uint64_t n
    cdef uint64_t row
...
@cython.boundscheck(False)
def tridiagsolve(np.ndarray[double,ndim=2] Lmat,np.ndarray[double,ndim=2] Umat,np.ndarray[double,ndim=1] bvec):

    cdef np.ndarray[double,ndim=1] xvec
    cdef uint64_t row
